...
public class Posts {
  ...
  @ElementCollection private Set<String> hashtags = new HashSet<>();

  @ElementCollection private Map<String, UUID> mentions = new HashMap<>();
  ...
  public Posts(
      ...
      Date timestamp,
      Set<String> hashtags,
      Map<String, UUID> mentions,
      List<HashtagPosts> postHashtags,
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(hashtags, other.hashtags)
        ...
        && Objects.equals(likeCount, other.likeCount)
        && Objects.equals(mentions, other.mentions)
        && Objects.equals(originalPostId, other.originalPostId)
        && Objects.equals(postHashtags, other.postHashtags)
        && Objects.equals(postLikes, other.postLikes)
        && Objects.equals(replyToId, other.replyToId)
        && Objects.equals(repostCount, other.repostCount)
